...
public class Main {
	...
	public static void main(String s[]) {
		...
		double coords3 [] = {1,2,3,4,5};
		Vecteur vecTest3 = new Vecteur(coords3);

		double coords4 [] = {3,9,33,18,28};
		Vecteur vecTest4 = new Vecteur(coords4);
...
System.out.println("------------------------------------");
		...
		System.out.println(mat5.inverse());
		
		System.out.println("------------------------------------");
		
		System.out.println(mat5.applicationLin(vecTest3));
		System.out.println(mat5.applicationLin(vecTest4));
